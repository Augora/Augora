...
const MapCirco = (props) => {
    ...
    useEffect(() => {
        ...
        const getSelectedCircoBox = (map, selectedCirco) => {
            ...
            drawSelectedCircoBox(map, selectedCirco, selectedCircoBox)
        }
        const drawSelectedCircoBox = (map, circo, box) => {
            // Dessiner la circo
            map.addLayer({
        ...
        const initMap = () => {
            ...
            map.on('style.load', () => {
                ...
                const selectedCirco = GEOJsonCirco.features.find((circo) => {
                    return circo.properties.nom_dpt.toLowerCase() === retirerAccentsFR(props.nom.toLowerCase()) && parseInt(circo.properties.num_circ) === props.num
                })
                getSelectedCircoBox(map, selectedCirco)
            })
        }
