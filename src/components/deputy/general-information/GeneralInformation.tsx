      ...
      <div className={`block__main general__main`}>
        <div className="main__picture">
          ...
          >
            ...
            <figure className="svg-placeholder" style={{ backgroundImage: `linear-gradient(-45deg, ${props.color.HSL.Full}, hsl(${props.color.HSL.H}, ${props.color.HSL.S}%, ${props.color.HSL.L + 5}%)` }}>
              {props.sexe === "F" ? (
                <svg className="icon-missingfemale" viewBox="0 0 390 500">
                  <ellipse transform="matrix(0.7071 -0.7071 0.7071 0.7071 -32.4978 174.1705)" cx="194" cy="126.3" rx="94.3" ry="94.3"/>
